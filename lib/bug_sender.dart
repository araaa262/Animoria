...
class _BugSenderPageState extends State<BugSenderPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchSenders() async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://hamzzboyz.jkt48.my.id:1734/mySender?key=${widget.sessionKey}"),
  ...
  Future<void> _addSender(String number, String name) async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://hamzzboyz.jkt48.my.id:1734/getPairing?key=${widget.sessionKey}&number=$number"),
      );
    ...
    if (confirmed == true) {
      ...
      try {
        ...
        final response = await http.delete(
          Uri.parse("http://hamzzboyz.jkt48.my.id:1734/deleteSender?key=${widget.sessionKey}&id=$senderId"),
        );
