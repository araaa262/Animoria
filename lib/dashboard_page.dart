...
class _DashboardPageState extends State<DashboardPage>
  ...
  final Color accentBlue = Color(0xFF3B82F6);
  ...
  final Color blueGradientStart = Color(0xFF1E3A8A);
  final Color blueGradientEnd = Color(0xFF3B82F6);
  ...
  void _connectToWebSocket() {
    channel = WebSocketChannel.connect(Uri.parse('http://hamzzboyz.jkt48.my.id:1734'));
