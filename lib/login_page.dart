...
const String baseUrl = "http://hamzzboyz.jkt48.my.id:1734";
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          if (showContact)
            TextButton(
              onPressed: () async {
                await launchUrl(Uri.parse("https://t.me/putluvluv1"),
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFF0F3460), Color(0xFF16213E), Color(0xFF0F3460)],
